...
const router = createRouter({
    ...
    routes: [
        ...
        { path: '/introduce', name: 'introduce', component: Introduce, title: '사업', icon: 'far fa-bell fa-fw text-2xl', meta: { isMenu: true, layout: 'DefaultLayout', requireAuth: true } },
        { path: '/goods', name: 'goods', component: Goods, title: '상품', icon: 'far fa-bell fa-fw text-2xl', meta: { isMenu: true, layout: 'DefaultLayout', requireAuth: true } },
        ...
        { path: '/inquiry', name: 'inquiry', component: Inquiry, title: '문의', icon: 'far fa-bell fa-fw text-2xl', meta: { isMenu: true, layout: 'DefaultLayout', requireAuth: true } },
        // {
