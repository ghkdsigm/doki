    ...
    <div class="bg-white">
      <!-- <div
        ...
        >
          <div
            id="plan"
            class="bg-gray-100 rounded-lg text-center overflow-hidden w-full transform hover:shadow-2xl hover:scale-105 transition duration-200 ease-in"
          >
            <div id="title" class="w-full py-5 border-b border-gray-400">
            ...
            <div id="content" class="">
              ...
              <div id="contain" class="leading-8 mb-10 text-lg font-light">
                ...
                <div id="choose" class="w-full mt-10 px-6">
                  <a
                    href="#"
                    class="w-full block bg-indigo-600 font-medium text-xl py-4 rounded-xl hover:shadow-lg transition duration-200 ease-in-out hover:bg-indigo-600 hover:text-white text-white"
                    >Choose</a
                  >
                </div>
              </div>
      ...
      <div class="grid gap-6 lg:mt-16 lg:mx-6 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mb-20 sm:mx-6 mx-4">
        ...
        <div class="px-6 py-4 transition-colors duration-200 transform rounded-lg bg-gray-100 hover:bg-gray-300 text-black hover:text-black">
            <p class="text-lg font-medium">Base</p>
            <h4 class="mt-2 text-4xl font-semibold">$39 <span class="text-base font-normal text-gray-600 dark:text-gray-400">/ Month</span></h4>
            <p class="mt-4 text-gray-500 dark:text-gray-300">For most businesses that want to optimaize web queries.</p>
        ...
        <div class="px-6 py-4 transition-colors duration-200 transform rounded-lg bg-gray-100 hover:bg-gray-300 text-black hover:text-black">
            <p class="text-lg font-medium">Exterprise</p>
            <h4 class="mt-2 text-4xl font-semibold">$199 <span class="text-base font-normal text-gray-600 dark:text-gray-400">/ Month</span></h4>
            <p class="mt-4 text-gray-500 dark:text-gray-300">For most businesses that want to optimaize web queries.</p>
